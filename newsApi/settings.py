...
SECRET_KEY = 'django-insecure-n%*2^_2pp^s!yk%^v$$x)q4-l(6+9#c)vnb*xf=p@dvd%xf7qx'

# SECURITY WARNING: don't run with debug turned on in production!
ALLOWED_HOSTS = ['od317.pythonanywhere.com', 'localhost', '127.0.0.1']
...
INSTALLED_APPS = [
    ...
    'corsheaders',     # Add this if installed
