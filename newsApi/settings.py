...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-n%*2^_2pp^s!yk%^v$$x)q4-l(6+9#c)vnb*xf=p@dvd%xf7qx')
...
# Database - PythonAnywhere uses MySQL by default, but we'll stick with SQLite
DATABASES = {
    'default': {
